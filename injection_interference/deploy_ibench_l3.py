...
def main():
    ...
    yaml_file = '/home/george/Workspace/Interference/injection_interference/iBench_custom/ibench-nginx-node-l3.yaml' if args.nginx else './iBench_custom/ibench-regular-node-l3.yaml'
