...
def main():
    ...
    yaml_file = '/home/george/Workspace/Interference/injection_interference/iBench_custom/ibench-nginx-node-cpu.yaml' if args.nginx else './iBench_custom/ibench-regular-node-cpu.yaml'
