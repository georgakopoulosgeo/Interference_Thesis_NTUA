    ...
    for replicas in REPLICAS_TO_TEST:
        for rps in RPS_STEPS:
            for scenario in INTERFERENCE_SCENARIOS:
                ...
                total_duration += STABILATION_TIME_AFTER_DELETION + STABILATION_TIME_AFTER_DEPLOYMENT + STABILATION_TIME_AFTER_INTERFERENCE + int(DURATION[:-1])*60 + SLEEP_BETWEEN_TESTS
